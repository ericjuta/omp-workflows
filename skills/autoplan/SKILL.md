...
compatibility: Requires omp-workflows and the built-in autoplan workflow.
---
...
2. Devise the most Long term elegant and production ready solution within that scope.
